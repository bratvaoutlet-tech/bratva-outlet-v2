      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            ...
            {/* Badge — será conectado ao store Zustand depois */}
            {/* <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-brand-600 text-[10px] font-bold text-white">3</span> */}
          </Link>
